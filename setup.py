...
class Dist(Command):
    ...
    def run(self):
        if self.clean:
            ...
            shutil.rmtree('management-tools.egg-info', ignore_errors=True)
...
setup(
    ...
    url='https://github.com/PeRDy/management-tools',
    download_url='https://github.com/PeRDy/management-tools',
    packages=[
        'management_tools',
    ],
